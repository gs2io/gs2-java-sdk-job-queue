...
public class DescribeJobByUserIdRequest extends Gs2BasicRequest<DescribeJobByUserIdRequest> {
	 ...
	 * @return this
	 */
	public DescribeJobByUserIdRequest withQueueName(String queueName) {
	 ...
	 * @return this
	 */
	public DescribeJobByUserIdRequest withUserId(String userId) {
		setUserId(userId);
		return this;
	}
	 ...
	 * @return this
	 */
	public DescribeJobByUserIdRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeJobByUserIdRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
