...
public class DescribeJobResultRequest extends Gs2BasicRequest<DescribeJobResultRequest> {
	 ...
	 * @return this
	 */
	public DescribeJobResultRequest withQueueName(String queueName) {
	 ...
	 * @return this
	 */
	public DescribeJobResultRequest withJobId(String jobId) {
		setJobId(jobId);
		return this;
	}
	 ...
	 * @return this
	 */
	public DescribeJobResultRequest withPageToken(String pageToken) {
	 ...
	 * @return this
	 */
	public DescribeJobResultRequest withLimit(Integer limit) {
		setLimit(limit);
		return this;
	}
